...
################################################################
# This is a generated script based on design: ps_axi_spi_bd
#
...
# source ps_axi_spi_bd_script.tcl
...
proc create_hier_cell_AXI_slow { parentCell nameHier } {
  ...
  if { [catch {set pin_control_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.MAX_COUNT_1MS {50000} $pin_control_0
  ...
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_pins axi_quad_spi_0/io0_o] [get_bd_pins adc_sdio_o]
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_pins axi_quad_spi_0/sck_o] [get_bd_pins adc_sclk_o]
  ...
  connect_bd_net -net pin_control_0_led_dout0_o [get_bd_pins pin_control_0/led_dout0_o] [get_bd_pins dout0_o]
  connect_bd_net -net pin_control_0_led_dout1_o [get_bd_pins pin_control_0/led_dout1_o] [get_bd_pins dout1_o]
  connect_bd_net -net pin_control_0_led_green_o [get_bd_pins pin_control_0/led_green_o] [get_bd_pins led_green_o]
  connect_bd_net -net pin_control_0_led_red_o [get_bd_pins pin_control_0/led_red_o] [get_bd_pins led_red_o]
  connect_bd_net -net pin_control_0_vadj_en_o [get_bd_pins pin_control_0/vadj_en_o] [get_bd_pins vadj_en_o]
  ...
  connect_bd_net -net xlslice_bit0_Dout [get_bd_pins xlslice_bit0/Dout] [get_bd_pins adc_ss2_o]
  connect_bd_net -net xlslice_bit1_Dout [get_bd_pins xlslice_bit1/Dout] [get_bd_pins adc_ss1_o]
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {3} $axi_interconnect_fast
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#UART 1#UART 1#UART 0#UART 0#I2C 1#I2C 1#I2C 0#I2C 0#Enet\
...
\
  ...
  set_property CONFIG.C_EXT_RST_WIDTH {1} $reset_slow
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins clk_fpga_divide/clk_out1] [get_bd_pins AXI_slow/ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins reset_slow/slowest_sync_clk]
  ...
  connect_bd_net -net axi_spi_control_0_adc_sclk_o [get_bd_pins AXI_slow/adc_sclk_o] [get_bd_ports adc_sclk_o]
  connect_bd_net -net axi_spi_control_0_adc_sdio_o [get_bd_pins AXI_slow/adc_sdio_o] [get_bd_ports adc_sdio_o]
  connect_bd_net -net axi_spi_control_0_adc_ss1_o [get_bd_pins AXI_slow/adc_ss1_o] [get_bd_ports adc_ss1_o]
  connect_bd_net -net axi_spi_control_0_adc_ss2_o [get_bd_pins AXI_slow/adc_ss2_o] [get_bd_ports adc_ss2_o]
  connect_bd_net -net fmc_present_i_0_1 [get_bd_ports fmc_present_i] [get_bd_pins AXI_slow/fmc_present_i]
  connect_bd_net -net pin_control_0_led_dout0_o [get_bd_pins AXI_slow/dout0_o] [get_bd_ports dout0_o]
  connect_bd_net -net pin_control_0_led_dout1_o [get_bd_pins AXI_slow/dout1_o] [get_bd_ports dout1_o]
  connect_bd_net -net pin_control_0_led_green_o [get_bd_pins AXI_slow/led_green_o] [get_bd_ports led_green_o]
  connect_bd_net -net pin_control_0_led_red_o [get_bd_pins AXI_slow/led_red_o] [get_bd_ports led_red_o]
  connect_bd_net -net pin_control_0_vadj_en_o [get_bd_pins AXI_slow/vadj_en_o] [get_bd_ports vadj_en_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_ports ps_clk_o] [get_bd_pins axi_interconnect_fast/ACLK] [get_bd_pins axi_interconnect_fast/M00_ACLK] [get_bd_pins axi_interconnect_fast/M01_ACLK] [get_bd_pins axi_interconnect_fast/M02_ACLK] [get_bd_pins axi_interconnect_fast/S00_ACLK] [get_bd_pins clk_fpga_divide/clk_in1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins reset_fast/slowest_sync_clk]
  ...
  connect_bd_net -net reset_fast_interconnect_aresetn [get_bd_pins reset_fast/interconnect_aresetn] [get_bd_ports ps_rst_n_o] [get_bd_pins axi_interconnect_fast/ARESETN] [get_bd_pins axi_interconnect_fast/M00_ARESETN] [get_bd_pins axi_interconnect_fast/M01_ARESETN] [get_bd_pins axi_interconnect_fast/M02_ARESETN] [get_bd_pins axi_interconnect_fast/S00_ARESETN]
  connect_bd_net -net reset_fast_peripheral_reset [get_bd_pins reset_fast/peripheral_reset] [get_bd_ports ps_rst_o]
  connect_bd_net -net reset_slow_interconnect_aresetn [get_bd_pins reset_slow/interconnect_aresetn] [get_bd_pins AXI_slow/ARESETN]
