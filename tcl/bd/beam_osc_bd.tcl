...
################################################################
# This is a generated script based on design: beam_osc_bd
#
...
# source ch_oscillator_bd_script.tcl
...
proc create_hier_cell_Ch_oscillator_hier { parentCell nameHier } {
  ...
  connect_bd_net -net Ch_sel_osc_cont_m_axis_tdata [get_bd_pins Ch_sel_osc_cont/m_axis_tdata] [get_bd_pins m_axis_tdata]
  connect_bd_net -net Ch_sel_osc_cont_m_axis_tvalid [get_bd_pins Ch_sel_osc_cont/m_axis_tvalid] [get_bd_pins m_axis_tvalid]
...
proc create_root_design { parentCell } {
  ...
  if { [catch {set complex_conjugator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.DATA_WIDTH {32} $complex_conjugator_0
  ...
  connect_bd_net -net complex_conjugator_0_m_axis_tdata_out [get_bd_pins complex_conjugator_0/m_axis_tdata_out] [get_bd_ports m_axis_tdata_out_0]
